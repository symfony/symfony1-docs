...
symfony コミュニティーにプラグインを寄付することは簡単です。あなたはプラグインを作成し、パッケージングし、symfony の  Web サイトにアップロードする方法についての[ドキュメントを読むことができます](http://www.symfony-project.org/jobeet/1_3/Doctrine/en/20#chapter_20_contributing_a_plugin)。
