...
symfonyにおいて、機能テストは[~`sfBrowser`|ブラウザー~](http://www.symfony-project.org/api/1_4/sfBrowser)クラスによって実装される、特別な~ブラウザー~をとおして実行されます。
...
テストメソッドは別のクラス、[`sfTestFunctional`](http://www.symfony-project.org/api/1_4/sfTestFunctional)によって提供されます。
