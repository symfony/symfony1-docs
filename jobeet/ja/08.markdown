...
![コマンドラインでテストする](http://www.symfony-project.org/images/jobeet/1_3/08/cli_tests.png)
...
![slugify()テスト](http://www.symfony-project.org/images/jobeet/1_3/08/slugify.png)
...
![メッセージつきのslugify()テスト](http://www.symfony-project.org/images/jobeet/1_3/08/slugify_doc.png)
...
![slugify()のバグ](http://www.symfony-project.org/images/jobeet/1_3/08/slugify_bug.png)
...
<propel>
`propel:data-load`タスクは内部でデータをロードするために[`sfPropelData`](http://www.symfony-project.org/api/1_3/sfPropelData)クラスを使います:
...
![ユニットテストのハーネス](http://www.symfony-project.org/images/jobeet/1_3/08/test_harness.png)
