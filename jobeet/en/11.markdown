...
In chapter 10, we created our first form with symfony. People are now able to post a new job on Jobeet but we ran out of time before we could add some tests. That's what we will do along this chapter. Along the way, we will also learn more about the form framework.
...
During chapter 1, you learned the `generate:app` task created a secured application by default.
...
Testing is at the heart of the symfony philosophy and tools. In this chapter, we have learned again how to leverage symfony tools to make the development process
