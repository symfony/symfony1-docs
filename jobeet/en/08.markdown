...
During the last two chapters, we reviewed all the features learned during the
first five chapters of the Practical symfony book to customize Jobeet features and add new ones. In the process, we have also touched on other more advanced symfony features.

Today, we will start talking about something completely different: automated
**tests**. As the topic is quite large, it will take us two full chapters to cover everything.
...
Unit tests will be covered in this chapter, whereas the following will be
...
some test data. During chapter 3, you learned to use the `propel:data-load`
