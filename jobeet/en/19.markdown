...
>**TIP**
>As the `propel:build --all --and-load` removes all tables and data from the database,
...
In the [`Date`](http://www.symfony-project.org/api/1_4/DateHelper) helper
group:
...
In the [`I18N`](http://www.symfony-project.org/api/1_4/I18NHelper) helper
group:
