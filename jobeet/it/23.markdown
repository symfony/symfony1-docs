...
di tempo forse vorrete anche [aggiornare](#chapter_22_sub_aggiornare_aggiornamento_symfony)
all'ultima versione del framework.

Il framework fornisce anche degli strumenti per facilitare il [deployment](#chapter_22_rilascio).
 ...
 * [`factories.yml`](#chapter_22_i_factory_factory)
...
[`sfContext`](#chapter_21_sidebar_la_classe_code_sfcontext_code_) e sono
configurati tramite i [factory](#chapter_22_i_factory_factory).
