...
configurati tramite i [factory](#chapter_16_sub_factories_factory).
...
nella [guida di riferimento](http://www.symfony-project.org/reference/1_4/it/) tutte le
...
sua comunità. E symfony ha una delle più incredibili e attive comunità
del mondo. Se iniziate a usare symfony per i vostri progetti, considerate
di unirvi alla comunità di symfony:
