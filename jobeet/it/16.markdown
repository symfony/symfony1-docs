...
>metodi `set()`. Accetta un nome e un oggetto come parametri e il metodo `get()`
...
Perché il codice precedente funzioni, è necessario copiare il file delle fixture di ieri
