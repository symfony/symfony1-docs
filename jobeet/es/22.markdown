...
Si utilizas Subversion para tu proyecto, también puedes enlazar tu proyecto con la últimas etiquetas de Symfony 1.3:
...
También puedes utilizar la rama 1.3 para tener los arreglos en tiempo real:

    $ svn propedit svn:externals lib/vendor/
      # symfony http://svn.symfony-project.com/branches/1.3/

Ahora, cada vez que hacemos un `svn up`, tendrás la última versión de Symfony 1.3.
