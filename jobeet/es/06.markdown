...
![Sentencias SQL en la web debug toolbar](http://www.symfony-project.org/images/jobeet/1_3/06/web_debug_sql.png)
...
![Página de Inicio ordenada por Categoría](http://www.symfony-project.org/images/jobeet/1_3/06/homepage.png)
...
![Paginación](http://www.symfony-project.org/images/jobeet/1_3/06/pagination.png)
...
![Error 404 para un puesto de trabajo expirado](http://www.symfony-project.org/images/jobeet/1_3/06/exception.png)
...
Para trabajar sobre una implementación en tu proyecto local. Por favor, usa la [API documentation](http://www.symfony-project.org/api/1_3/) y toda la [documentation](http://www.symfony-project.org/doc/1_3/) disponible en el sitio web de Symfony para ayudarte. Nos veremos tra vez mañana con nuestra implementación.
