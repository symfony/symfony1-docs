...
>una mirada a la [i18n API](http://www.symfony-project.org/api/1_3/i18n) para
>más detalles.
...
En el grupo de helper [`Date`](http://www.symfony-project.org/api/1_3/DateHelper) 
:
...
En el grupo de helper [`Number`](http://www.symfony-project.org/api/1_3/NumberHelper) :
...
En el grupo de helper [`I18N`](http://www.symfony-project.org/api/1_3/I18NHelper) :
