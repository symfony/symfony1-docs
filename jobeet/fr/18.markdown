...
aucun comportement est enregistrée, et le formulaire fonctionne toujours comme avant.
...
>
>Bien que le JavaScript que nous avons écrit pour le moteur de recherche est statique,
