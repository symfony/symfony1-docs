...
l'afficher. Le ~Template|Templates~ du formulaire est le même, que vous voulez créer
...
espérons que vous avez maintenant une meilleure compréhension du framework de formulaire desymfony.
