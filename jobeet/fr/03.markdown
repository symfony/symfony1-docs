...
C'est tout pour aujourd'hui. Je vous l'indiquais dans l'introduction. Aujourd'hui, nous avons
à peine écrit du code PHP, mais nous avons un module web de travail pour le modèle job,
prêts à être modifié et personnalisé. Rappelez-vous, pas de code PHP signifie pas de bogues non plus !
